...
append-only). **Amended by ADR-027 (2026-09-06)**: the extractor runs
...
convention). **Amended by ADR-027 §4 (2026-09-06)**: supersede CLOSES
...
**Amended by ADR-027 §4 (2026-09-06)**: `hydrate` and `by_period`
